...
(function(){
  ...
  HomeController.$inject = ['$rootScope', 'Authentication', '$translate', '$http', '$stateParams', 'SocialProviders', '$mdDialog', '$mdMedia'];

  function HomeController ($rootScope, Authentication, $translate, $http, $stateParams, SocialProviders, $mdDialog, $mdMedia) {
    ...
    vm.viewSkill = function (ev, skill) {
      $mdDialog.show({
      ...
      function viewHomeSkillDialogController ($scope, skill) {
        ...
        viewVm.currentLanguage = vm.currentLanguage;
        viewVm.skill = skill;
        viewVm.title = 'SKILL_DETAIL';
    ...
    vm.viewEducation = function (ev, education) {
      $mdDialog.show({
      ...
      function viewHomeEducationDialogController ($scope, education) {
        ...
        viewVm.currentLanguage = vm.currentLanguage;
        viewVm.education = education;
        viewVm.title = 'EDUCATION_DETAIL';
    ...
    vm.viewExperience = function (ev, experience) {
      $mdDialog.show({
      ...
      function viewHomeExperienceDialogController ($scope, experience) {
        ...
        viewVm.currentLanguage = vm.currentLanguage;
        viewVm.experience = experience;
        viewVm.title = 'EXPERIENCE_DETAIL';
        viewVm.durationInfo = vm.getExperienceDurationInfo(viewVm.experience.duration);
