 ...
 * v0.9.15
 */
// NOTE: (Francisco Fornell) Added angular-trasnlate directive to the labels
(function (window, angular, undefined) {
  ...
  angular.module('md-table-pagination.html', []).run(['$templateCache', function($templateCache) {
    $templateCache.put('md-table-pagination.html',
      '<span class="label" ng-if="$pagination.showPageSelect()" translate>{{ $pagination.$label[\'page\'] }}</span>\n' +
      '\n' +
      ...
      '</md-select>\n' +
      '\n' +
      '<span class="label" translate>{{ $pagination.$label[\'rowsPerPage\'] }}</span>\n' +
      '\n' +
      ...
      '</md-select>\n' +
      '\n' +
      '<span class="label">{{ $pagination.min() + 1}} - {{ $pagination.max() }} {{ $pagination.$label[\'of\'] | translate }} {{ $pagination.total}}</span>\n' +
      '\n' +
